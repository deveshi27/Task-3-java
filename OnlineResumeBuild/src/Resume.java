...
class Resume extends JFrame implements ActionListener {
    ...
    // textfield to enter
    JTextField namee, gender, fathernamee, cityy, emaill, skills, college, degree, linkedln, github, hackerrnk, contact,
            experience;
    ...
    Resume() {
        super("Resume");
        p = new JFrame("Online Resume Builder");
        ...
        linkedln = new JTextField();
        github = new JTextField();
        hackerrnk = new JTextField();
    ...
    public void actionPerformed(ActionEvent evt) {
        ...
        if (s.equals("REGISTER")) {
            JFrame f;
            if (name.equals("") || fathername.equals("") || city.equals("") || email.equals("") || gender.equals("")
                    || password1.equals("") || password2.equals("") || ucollege.equals("") || udegree.equals("")
                ...
                try {
                    ...
                    PdfDocument pdf = new PdfDocument(new PdfWriter(name+ "_Resume.pdf"));
                    // Create a new Document using the PdfDocument
                    Document document = new Document(pdf);

                    // Save data to PDF
                    String resumeData = "Name: " + name + "\nGender: " + gender + "\nFather name: " + fathername
                            + "\nPassword: " + password1 + "\nCity: " + city + "\nEmail: " + email + "\nSkills: "
                            + uskills + "\nCollege: " + ucollege + "\nDegree: " + udegree + "\nLinkedin: " + ulinkdln
                            + "\nGithub: " + ugithub + "\nContact: " + ucontact + "\nExperience: " + uexperience;

                    Paragraph paragraph = new Paragraph(resumeData);
